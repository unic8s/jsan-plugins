/*
 * Original shader from: https://www.shadertoy.com/view/wsGczG
 */
...
float stretch = 0., gunsUp = 0., gunsForward = 0., edWalk = 0., edTwist = 0., edDown = 0., edShoot = 0., doorOpen = 0., glow = 0.;
...
MarchData gunPod(vec3 p) {
    MarchData result = MarchData(0., vec3(0.), 0.);
    setBodyMaterial(result);
