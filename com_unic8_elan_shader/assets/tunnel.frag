...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
	...
	fragColor = vec4(vec3(col * sin(time*rainbowSpeed), col * sin(time*rainbowSpeed + 2.0*(PI/3.0)), col * sin(time*rainbowSpeed + 4.0*(PI/3.0))), alpha) + color;
}
