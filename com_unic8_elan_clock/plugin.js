module.exports = {
    ...
    install: function (options) {
        ...
        this.timeStamp = options.inputs.time;
        this.colorHours = options.inputs.hours;
        this.colorMinutes = options.inputs.minutes;
        this.colorSeconds = options.inputs.seconds;
